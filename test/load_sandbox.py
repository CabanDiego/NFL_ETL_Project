'''Testing SQL Queries on local DB setup'''
from pathlib import Path
from sqlalchemy import create_engine
import os
import sys

#Using the root to find extract.py 
PROJECT_ROOT = Path(__file__).resolve().parent.parent
sys.path.append(str(PROJECT_ROOT))

from src.manage_csv.extract import read_and_load

#Creating a local database to use for testing using sqlite
...
#Create SQLite engine to connect to the local db
